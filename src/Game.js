...
export default function Game ()
{
    ...
    const patoune = useGLTF('./modeles/cat_paw.glb')
         ...
         <RigidBody 
            ...
            >
                <CuboidCollider name="active" args={[0.7, 0.7, 0.7]} position={[34, 1, 18.5]}>
                    <mesh rotation={[0, Math.PI * patouneRotation, 0]} scale={0.03} geometry={patoune.nodes.Line001.children[0].geometry}>
                        <meshBasicMaterial color={'#ffd59d'} />
                    </mesh>
                </CuboidCollider>
